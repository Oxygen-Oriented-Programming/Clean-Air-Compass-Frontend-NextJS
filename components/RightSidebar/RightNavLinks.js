  ...
  return (
    <>
      ...
      <div className='flex flex-col bg-black items-center h-fit w-full space-y-2.5'>
        <Link
          className='flex h-fit px-4 py-2.5 font-normal rounded transition-all hover:bg-purple-700 text-white'
        ...
        <Link
          className='block px-4 py-2.5 font-normal rounded transition-all hover:bg-purple-700 text-white'
