  ...
  return (
    <>
      <div className='flex flex-col items-center p-4 text-center align w-fit '>
        <div className='w-fit p-2.5 mt-3 text-center items-center rounded-xl px-4 duration-300 cursor-pointer h-fit bg-gray-800'>
          <div className='block pt-2 mb-2 font-medium '>
            ...
            <p className='text-sm text-gray-300 hover:animate-pulse '>
