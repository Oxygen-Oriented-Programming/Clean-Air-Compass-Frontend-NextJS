  ...
  return (
    <>
      ...
      <form
        ...
        className='w-full p-2 mx-auto my-4 transition-all border-2 md:w-2/3 bg-emerald-300 border-emerald-600'
      >
        <div className='flex items-center justify-around p-1 my-2 transition-all'>
          <div className='flex flex-col items-center w-3/5 transition-all'>
            <label
              htmlFor='location'
              className='mb-1 text-xs text-center transition-all'
            >
              {' '}
              Location
            </label>
            <input
              ...
              className='w-full pl-1 text-sm transition-all'
            />
          </div>
          <div className='w-1/3 mx-1 transition-all'>
            <label
              htmlFor='phoneNumber'
              className='block text-sm text-center transition-all'
            >
              Phone Number
            </label>
            <input
          ...
          <button
            type='submit'
            className='px-10 py-1 mx-1 transition-all bg-emerald-700 text-gray-50 hover:bg-red-500'
          >
            Create Alert
          </button>
        </div>
              ...
              <>
                ...
                <button onClick={() => handleDelete(alert.id)} className=''>
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke='currentColor'
                    className='w-5 h-5 ml-5 mr-2 text-red-600 transition-all duration-200 cursor-pointer hover:text-red-200 hover:pt-0'
                  >
                    <path
                      strokeLinecap='round'
