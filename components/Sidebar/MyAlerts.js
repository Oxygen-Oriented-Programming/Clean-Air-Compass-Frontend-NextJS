  ...
  return (
    <>
      <div className='flex flex-col transition-all items-center w-full h-full space-y-2.5 bg-transparent pb-2'>
        <h3 className='my-4 font-mono text-3xl font-bold text-center text-white '>
          My Alerts
        </h3>
        <form
          ...
          ref={formRef}
        >
          <div className='flex flex-col items-center justify-center px-2 round-4xl sm:w-1/2 md:w-3/5 sm:px-4'>
            <label
              htmlFor='location'
              className='flex pt-3 font-mono text-2xl font-bold text-center'
            >
              Location
            </label>
            <input
              ...
              id='location'
              type='text'
              className='h-16 text-lg font-normal text-center bg-gray-800 '
          ...
          <div className='flex flex-col items-center justify-center w-full px-2 round-4xl sm:w-1/2 md:w-3/5 sm:px-4'>
            <label
              htmlFor='phoneNumber'
              className='block mb-1 font-mono text-xl font-bold text-center text-white'
            >
              Phone Number
            </label>
            <input
          ...
          <div className='flex flex-col items-center w-32 p-4 pt-2 font-mono sm:w-1/2 sm:px-5'>
            <label
              htmlFor='airQualityThreshold'
              className='block mb-1 text-lg font-bold text-center font mono '
            >
              Air Quality
            </label>
            <select
        ...
        <div className='flex flex-col items-center p-3 my-8'>
          {!alerts.length ? (
            ...
            alerts.map((alert, i) => (
              <div
                key={i}
                className='flex items-center justify-between w-full px-2 mb-2 text-center text-black bg-gray-100 sm:px-4'
              >
                <p className='text-sm'>
