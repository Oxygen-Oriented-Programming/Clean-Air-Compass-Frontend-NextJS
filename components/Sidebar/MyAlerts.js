    ...
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center w-full px-2 sm:w-1/2 md:w-3/5 sm:px-4">
          <label
            htmlFor="location"
            className="block mb-1 text-xs font-medium text-center"
          >
            Location
          </label>
          <input
            ...
            className="w-full px-2 py-1 text-sm border-2 border-green-600 rounded-md"
          />
        </div>
        <div className="w-full px-2 sm:w-1/2 md:w-1/3 sm:px-4">
          <label
            htmlFor="phoneNumber"
            className="block mb-1 text-xs font-medium text-center"
          >
        ...
        <div className="w-full px-2 sm:w-1/2 md:w-1/5 sm:px-4">
          <label
        ...
        <button
          type="submit"
          className="w-full px-8 py-2 mt-4 text-white bg-black rounded-md sm:w-auto hover:bg-purple-700 sm:mt-0"
        >
          Create Alert
        </button>
      </form>
